    ...
    <div className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col z-20 sticky top-0 h-screen">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-8 mb-4 px-3 block">Preferences</p>
        ...
        <header className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between z-10 sticky top-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 pl-6 border-l border-slate-200">
               ...
               <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-brand-600 to-indigo-600 flex items-center justify-center text-white font-bold shadow-md">
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-500">Total Uploaded</p>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-500">Matched Patients</p>
                <p className="text-2xl font-extrabold text-slate-900">386</p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-500">Match Accuracy</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                  ...
                  <button className="text-sm font-bold text-brand-600 hover:bg-brand-50 px-3 py-1.5 rounded-lg transition-colors">
                    View All Filtered
                  </button>
                </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-slate-50 border-b border-slate-100">
                        <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Anon ID</th>
                        <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Diagnosis</th>
                        <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Eligible Trial</th>
                      ...
                      {isLoading ? (
                        Array.from({ length: 4 }).map((_, i) => (
                          <tr key={i} className="animate-pulse">
                            <td className="px-6 py-4"><div className="w-20 h-4 bg-slate-200 rounded mb-2"></div><div className="w-12 h-3 bg-slate-100 rounded"></div></td>
                            <td className="px-6 py-4"><div className="w-32 h-4 bg-slate-200 rounded mb-2"></div><div className="w-20 h-3 bg-slate-100 rounded"></div></td>
                            <td className="px-6 py-4"><div className="w-40 h-6 bg-indigo-100 rounded mb-2"></div><div className="w-24 h-3 bg-slate-100 rounded"></div></td>
                            <td className="px-6 py-4"><div className="w-16 h-4 bg-brand-100 rounded mb-2"></div><div className="w-full h-2 bg-slate-100 rounded"></div></td>
                            <td className="px-6 py-4"><div className="w-8 h-8 bg-slate-100 rounded-xl"></div></td>
                          </tr>
                        ))
                      ) : (
                        matchedPatients.map((patient, i) => (
                          <tr key={i} className="hover:bg-slate-50/50 transition-colors animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
                            ...
                            <td className="px-6 py-4">
                              <div className="text-sm font-bold text-indigo-700 bg-indigo-50 inline-block px-3 py-1 rounded-lg">
                                {patient.trial}
                              </div>
                              <div className="text-xs font-medium text-slate-500 mt-1 flex items-center space-x-1">
                                ...
                                <span>Reason: Biomarker match</span>
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center space-x-2">
                                ...
                                <div className="w-16 h-2 bg-slate-100 rounded-full overflow-hidden">
                                  <div className="h-full bg-brand-500 rounded-full" style={{ width: `${patient.match}%` }}></div>
                                </div>
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-brand-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-brand-500/20 relative overflow-hidden">
                ...
                <p className="text-brand-100 text-sm font-medium mb-6">Securely upload and anonymize electronic health records for AI matching.</p>
                 ...
                 <div className="space-y-5">
                   <div>
                     <div className="flex justify-between text-sm font-bold mb-2">
                       <span className="text-slate-700">Awaiting Matching</span>
                   ...
                   <div>
                     <div className="flex justify-between text-sm font-bold mb-2">
                       <span className="text-brand-700">Matches Found</span>
                       <span className="text-slate-900">386</span>
                     </div>
                     <div className="w-full h-2.5 bg-brand-100 rounded-full overflow-hidden">
                       <div className="bg-brand-500 h-full rounded-full" style={{ width: '35%' }}></div>
                     </div>
                   </div>
                   
                   <div>
                     <div className="flex justify-between text-sm font-bold mb-2">
                       <span className="text-emerald-700">Enrolled in Trial</span>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-8">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea rows="3" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none resize-none" placeholder="Brief history..."></textarea>
                </div>
                ...
                <div>
                   ...
                   <div className="border-2 border-dashed border-slate-300 bg-slate-50 hover:bg-slate-100 transition-colors rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer text-center">
                     ...
                     <p className="text-xs font-medium text-slate-500">PDF, DICOM, JSON (Max 50MB)</p>
                   </div>
                </div>
            ...
            <div className="px-8 py-5 border-t border-slate-100 bg-slate-50 flex justify-end space-x-4">
               ...
               <button className="px-6 py-3 bg-brand-600 text-white font-bold rounded-xl hover:bg-brand-700 shadow-lg shadow-brand-500/30 transition-all">
                 Process & Match
               </button>
            </div>
          </div>
...
function DoctorProfile() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      {showSuccess && (
        <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 p-4 rounded-xl flex items-center space-x-3 mb-4 animate-fade-in-up">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden animate-fade-in-up">
        <div className="p-8 border-b border-slate-100 flex items-center space-x-6">
          <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-brand-600 to-indigo-600 flex items-center justify-center text-white text-3xl font-bold shadow-md">
            {user?.name ? user.name.charAt(0).toUpperCase() : 'D'}
          </div>
          <div>
            <h2 className="text-2xl font-bold text-slate-900">{user?.name || 'Doctor'}</h2>
            <p className="text-slate-500 font-medium tracking-wide capitalize">{user?.role || 'Doctor'}</p>
          </div>
        </div>
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-brand-500 transition-colors" placeholder="Enter your organization..." defaultValue="" />
            </div>
          </div>
